...
<main class="form-signin">
    <form method="post" action="/Hospital1/signIn" style="background: #f5d3ee; width: 600px; padding: 50px;
...
<%--        </div>--%>
    <br style="line-height: 3px">
        ...
        <p>Don't have an account? <a href="http://localhost:8080/Hospital1/patient_signup.jsp" style="color: #e887cb"> Create account</a> </p>
    </form>
</main>
